...
export const legalDocuments: LegalDocument[] = [
  ...
  {
    path: '/Routes/privacy', title: 'Privacy Policy', description: 'How Orbit Systems B.V. processes personal data in connection with Orbit AI.', updated: '7 September 2026',
    sections: [
      ...
      { title: 'Transfers and retention', paragraphs: ['Providers may process data outside the Netherlands or European Economic Area. Where required, Orbit uses an applicable transfer mechanism and evaluates safeguards.', 'Inactive recruitment applications and their CVs are scheduled for deletion six months after the last application activity, unless the candidate is hired or a longer period is required by law. Other data is retained only as long as reasonably needed for the purposes described, legal obligations, disputes, security, backups, and enforcement.'] },
      ...
      { title: 'Requests and deletion', paragraphs: ['Use account settings where available or contact support@orbitdev.org. Candidates may use the same address to request access, correction, withdrawal, or early deletion of an application. Describe the account or application without sending passwords, recovery codes, API keys, or identity documents unless Orbit provides a secure and necessary verification process.'] },
