(() => {
  ...
  const routeMap = new Map([
    ...
    ["refund policy", "/Routes/refund.html"],
    ["refunds", "/Routes/refund.html"],
    ["acceptable use", "/Routes/acceptabe.html"],
    ["acceptable use policy", "/Routes/acceptabe.html"],
    ["ai usage policy", "/Routes/ai-usage.html"],
    ["ai use", "/Routes/ai-usage.html"],
    ["dpa", "/Routes/dpa.html"],
    ["data processing agreement", "/Routes/dpa.html"],
    ["security policy", "/Routes/security.html"],
    ["security", "/Routes/security.html"],
    ["copyright policy", "/Routes/copyright.html"],
    ["copyright", "/Routes/copyright.html"],
    ["trademark policy", "/Routes/trademark.html"],
    ["trademark", "/Routes/trademark.html"],
    ["open source licenses", "/Routes/open-source.html"],
    ["open source", "/Routes/open-source.html"],
    ["accessibility statement", "/Routes/accessibility.html"],
